...
KW_INT:'int'; KW_FLOAT:'float'; KW_STRING:'string'; KW_OBJECT:'object'; KW_MIXED:'mixed'; KW_MAPPING:'mapping'; KW_FUNCTION:'function'; KW_BUFFER:'buffer'; KW_VOID:'void'; KW_STRUCT:'struct'; KW_CLASS:'class'; KW_ARRAY:'array'; KW_CLOSURE:'closure'; KW_TREE:'__TREE__'; KW_NEW:'new'; KW_SIZEOF:'sizeof'; KW_EFUN:'efun';
