...
import { PpBodyContext } from "./LPCParser";
...
export interface LPCParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by `LPCParser.ppBody`.
	 * @param ctx the parse tree
	 */
	enterPpBody?: (ctx: PpBodyContext) => void;
	/**
	 * Exit a parse tree produced by `LPCParser.ppBody`.
	 * @param ctx the parse tree
	 */
	exitPpBody?: (ctx: PpBodyContext) => void;
