...
export class LPCParser extends Parser {
	...
	public static readonly RULE_inheritPath = 48;
	public static readonly RULE_prototypeStatement = 49;
	public static readonly RULE_mappingLiteral = 50;
	public static readonly RULE_mappingPairList = 51;
	public static readonly RULE_mappingPair = 52;
	...
	// @RuleVersion(0)
	public inheritPath(): InheritPathContext {
		let _localctx: InheritPathContext = new InheritPathContext(this._ctx, this.state);
	...
	private static readonly _serializedATNSegment1: string =
		"\x03\x02\x02\x02\u01FF\u01FD\x03\x02\x02\x02\u0200\u0202\x07\x06\x02\x02" +
...
export class InheritPathContext extends ParserRuleContext {
	public Identifier(): TerminalNode[];
	public Identifier(i: number): TerminalNode;
	public Identifier(i?: number): TerminalNode | TerminalNode[] {
		if (i === undefined) {
	...
	// @Override
	public get ruleIndex(): number { return LPCParser.RULE_inheritPath; }
	// @Override
	public accept<Result>(visitor: LPCVisitor<Result>): Result {
